		...
		<div class="dc-dashboardboxcontent">
			<form class="dc-prescription-form" method="post">
				...
				<div class="dc-dashboardbox dc-prescriptionbox">
                    ...
                    <select class="form-control form-control-lg" name="delivery_status">
					    <option value="">Oû en êtes vous avec la livraison?</option>
					    <option value="Pas encore livre" <?php if($delivery_status == "Pas encore livre") echo("selected")?>>Pas encore livré</option>
						<option  value="Livre"<?php if($delivery_status == "Livre") echo("selected")?>>livré</option>
					</select>
